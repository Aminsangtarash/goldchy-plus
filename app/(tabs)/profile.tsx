    ...
    <View className="flex-1 bg-background-dark">
      ...
      >
        ...
        <View className="px-5" style={{ paddingTop: insets.top + 16 }}>
          ...
          {/* Settings Section */}
          <Text className="text-text-primary text-lg font-semibold mb-3">Settings</Text>
          <Card padding="none" className="mb-6">
            <View className="px-4">
          ...
          <Card variant="gold" className="mb-6">
            <View className="flex-row items-center">
              <View className="w-12 h-12 bg-primary-500 rounded-full items-center justify-center">
                <Ionicons name="gift" size={24} color="#0D0D1A" />
              </View>
              <View className="flex-1 ml-3">
                <Text className="text-text-primary font-semibold">Invite Friends</Text>
