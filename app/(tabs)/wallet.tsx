  ...
  return (
    <View className="flex-1 bg-background-dark">
      ...
      >
        ...
        <View className="px-5" style={{ paddingTop: insets.top + 16 }}>
          ...
          <Card variant="gold" padding="lg" className="mb-4">
            <View className="items-center">
              <Text className="text-text-secondary text-sm mb-2">Total Portfolio Value</Text>
          ...
          <View className="px-5">
            <View className="flex-row items-center justify-between mb-4">
              <Text className="text-text-secondary text-sm">
                Total Gold Value: <Text className="text-primary-500 font-semibold">{totalGoldValue} تومان</Text>
              </Text>
            </View>
                  ...
                  <View className="flex-row items-center">
                    ...
                    <View className="items-end">
                      ...
                      <View className="flex-row items-center">
                        ...
                        <Text
                          className={`text-sm ${
                            asset.change >= 0 ? 'text-accent-success' : 'text-accent-error'
                          }`}
                        >
                          {asset.change}%
                        </Text>
          ...
          <View className="px-5">
            ...
            <Card className="mb-6">
              <View className="items-center py-4">
                <Ionicons name="wallet" size={48} color="#FFB800" />
                <Text className="text-text-secondary text-sm mt-4 mb-2">Available Balance</Text>
                <Text className="text-text-primary text-3xl font-bold">{cashBalance}</Text>
        ...
        <View className="px-5">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-text-primary text-lg font-semibold">Recent Transactions</Text>
            <TouchableOpacity>
