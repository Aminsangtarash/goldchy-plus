...
import { Card, Input, PriceCard } from '@/components';
...
const marketData: Record<TabType, MarketItem[]> = {
  ...
  coin: [
    ...
    { id: '4', name: 'سکه گرمی', nameEn: 'Gram Coin', price: '۷,۲۰۰,۰۰۰', change: 50000, changePercent: 0.70, icon: '🪙' },
  ],
  currency: [
    ...
    { id: '3', name: 'پوند انگلیس', nameEn: 'GBP', price: '۷۹,۸۰۰', change: 400, changePercent: 0.50, icon: '🇬🇧' },
      ...
      >
        ...
        <Card variant="gold" className="mb-4">
          <View className="flex-row items-center justify-between">
            <View>
              <Text className="text-text-secondary text-sm mb-1">Live Gold Price</Text>
              <Text className="text-text-primary text-2xl font-bold">$2,625.50</Text>
              <View className="flex-row items-center mt-1">
                <Ionicons name="trending-up" size={16} color="#4CAF50" />
                <Text className="text-accent-success text-sm ml-1">+0.46% today</Text>
              </View>
            </View>
              ...
              <View className="flex-row items-center">
                ...
                <View className="items-end">
                  ...
                  <View className="flex-row items-center">
                    ...
                    <Text
                      className={`text-sm ${
                        item.change >= 0 ? 'text-accent-success' : 'text-accent-error'
                      }`}
                    >
                      {item.changePercent}%
                    </Text>
