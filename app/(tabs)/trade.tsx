    ...
    <View className="flex-1 bg-background-dark">
      ...
      >
        ...
        <View className="px-5 mb-6">
          <Text className="text-text-secondary text-sm mb-3">Select Gold Type</Text>
            ...
            {goldTypes.map((gold) => (
              ...
              >
                ...
                <Text className="text-text-muted text-xs mt-1">
                  {formatNumber(gold.price)} تومان/{gold.unit === 'gram' ? 'گرم' : 'عدد'}
                </Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
          ...
          <Card variant="outlined">
            <View className="flex-row items-center justify-between mb-4">
              ...
              <View className="flex-row">
                ...
                >
                  <Text
                    className={inputType === 'weight' ? 'text-secondary-900' : 'text-text-secondary'}
                  >
                ...
                >
                  <Text
                    className={inputType === 'price' ? 'text-secondary-900' : 'text-text-secondary'}
                  >
                    Toman
                  </Text>
                </TouchableOpacity>
        ...
        <View className="px-5 mb-6">
          <Card>
            ...
            <View className="flex-row justify-between mb-3">
              ...
              <Text className="text-text-primary font-medium">{selectedGold.name}</Text>
            </View>
            <View className="flex-row justify-between mb-3">
              <Text className="text-text-muted">Weight</Text>
              <Text className="text-text-primary font-medium">
                {formatNumber(calculateWeight())} {selectedGold.unit === 'gram' ? 'گرم' : 'عدد'}
              </Text>
            </View>
            <View className="flex-row justify-between mb-3">
        ...
        <View className="px-5 mb-6">
          <View className="flex-row items-center justify-between bg-background-card rounded-xl p-4">
            ...
            <Text className="text-text-primary font-semibold">۱۲,۵۰۰,۰۰۰ تومان</Text>
          </View>
        </View>
