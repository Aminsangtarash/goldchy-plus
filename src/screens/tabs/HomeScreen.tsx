  ...
  return (
    <View className="flex-1 bg-background-dark">
      <ScrollView
        ...
        {/* Header */}
        <View className="px-5 pb-6" style={{paddingTop: insets.top + 16}}>
        ...
        <View className="px-5 mb-6">
          <Card variant="gold" padding="lg">
            ...
            <View className="flex-row justify-between">
              <IconButton icon="add" variant="primary" size="lg" label="Deposit" />
              <IconButton icon="arrow-up" variant="default" size="lg" label="Withdraw" />
              <IconButton icon="swap-horizontal" variant="default" size="lg" label="Transfer" />
              <IconButton icon="receipt-outline" variant="default" size="lg" label="History" />
            </View>
          </Card>
        </View>
          ...
          <View className="flex-row">
            <Card className="flex-1 mr-3 items-center">
              <View className="w-12 h-12 rounded-full bg-primary-500/20 items-center justify-center mb-2">
                <Icon name="cart-outline" size={24} color="#FFB800" />
              </View>
              <Text className="text-text-primary text-sm font-medium">Buy Gold</Text>
            </Card>
            <Card className="flex-1 mr-3 items-center">
              <View className="w-12 h-12 rounded-full bg-accent-success/20 items-center justify-center mb-2">
                <Icon name="trending-up" size={24} color="#4CAF50" />
              </View>
              <Text className="text-text-primary text-sm font-medium">Sell Gold</Text>
            </Card>
            <Card className="flex-1 items-center">
              <View className="w-12 h-12 rounded-full bg-accent-info/20 items-center justify-center mb-2">
                <Icon name="gift-outline" size={24} color="#2196F3" />
              </View>
              <Text className="text-text-primary text-sm font-medium">Gift Gold</Text>
            </Card>
          </View>
        </View>
