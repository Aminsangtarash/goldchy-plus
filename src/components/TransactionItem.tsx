...
> = {
  buy: { icon: 'arrow-down-circle', color: '#4CAF50', bgColor: 'bg-accent-success/20' },
  sell: { icon: 'arrow-up-circle', color: '#F44336', bgColor: 'bg-accent-error/20' },
  deposit: { icon: 'add-circle', color: '#4CAF50', bgColor: 'bg-accent-success/20' },
  withdraw: { icon: 'remove-circle', color: '#FF9800', bgColor: 'bg-accent-warning/20' },
  transfer: { icon: 'swap-horizontal', color: '#2196F3', bgColor: 'bg-accent-info/20' },
};
